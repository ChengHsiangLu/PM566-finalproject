...
In this step, I just want to convert character variables into numeric variables.
...
There are only 2.7% NAs in my dataset which are not significant. Therefore, I'm going to remove NA values
